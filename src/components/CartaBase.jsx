...
function CartaBase({ link, colore, imgURL, title, desc1, desc2, testo }) {
    return (
                ...
                <div className="h-50 hover:scale-105 transition-all ease-linear cursor-pointer">
                    ...
                    <div className={`${colore} p-6 grow flex flex-col justify-between rounded-b-xl`}>
                        <div>
                            ...
                            {
                                testo == "In arrivo" ?
                                    <button className="uppercase ont-bold text-gray-300 bg-zinc-900/[.95]  rounded">{testo}</button>
                                    :
                                    <button className="bg-indigo-600 text-white rounded hover:bg-indigo-400 duration-500">{testo}</button>
                            }
                        </div>
                    </div>
                </div>
